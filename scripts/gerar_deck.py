#!/usr/bin/env python3
"""Gera HTML autônomo e PDF (um slide por página A4 paisagem) a partir de mirandastech_ia_pesquisa.html."""
import re, sys, time
from pathlib import Path
AQUI=Path(__file__).resolve().parent
FONTE=AQUI/"mirandastech_ia_pesquisa.html"
HTML=AQUI/"Manual_Uso_de_IA_na_Pesquisa_Cientifica_MirandasTech.html"
PDF=AQUI/"Manual_Uso_de_IA_na_Pesquisa_Cientifica_MirandasTech.pdf"
